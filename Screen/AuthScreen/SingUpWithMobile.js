...
const SingUpWithMobile = ({ navigation }) => {
    ...
    return (
        <Box style={{ flex: 1, backgroundColor: "#ffffff", paddingHorizontal: 30, }}>
            ...
            <View style={{ display: "flex", justifyContent: "flex-start", paddingBottom: 20 }}>
                ...
                <Text style={{ color: "#000", fontSize: 20, fontWeight: 400 }}>    With Phone Number</Text>
            </View>

            <Box style={{ paddingTop: 40 }} >
                <View style={{ width: '100%', padding: 10, alignItems: 'center' }}>
                    <TextInput placeholder='First Name' style={{ backgroundColor: "#f2f2f2", height: 60, width: "100%", borderRadius: 8, padding: 20 }} />
                </View>
                <View style={{ width: '100%', padding: 10, alignItems: 'center' }}>
                    <TextInput placeholder='Last Name' style={{ backgroundColor: "#f2f2f2", height: 60, width: "100%", borderRadius: 8, padding: 20 }} />
                </View>
                <View style={{ width: '100%', padding: 10, alignItems: 'center' }}>
                ...
                <View style={{ width: '100%', padding: 15, display: "flex", flexDirection: "row", justifyContent: "flex-end" }}>
                    ...
                    <View>
                        <TouchableOpacity onPress={() => navigation.navigate('SignUpScreen')}><Text style={{ color: "#8f8f8f" }}>Register with email</Text></TouchableOpacity>
                    </View>
                </View>
                <View style={{ width: '100%', padding: 10, alignItems: 'center' }}>
...
export default SingUpWithMobile;
