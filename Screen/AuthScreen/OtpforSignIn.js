    ...
    return (
        <Box style={{ flex: 1, backgroundColor: "#ffffff", paddingHorizontal: 30, }}>
            ...
            <View style={{ display: "flex", justifyContent: "flex-start", paddingBottom: 20 }}>
                <Text style={{ color: "#000", fontSize: 40, fontWeight: 600 }}> Enter OTP</Text>
            </View>
            ...
            <Box style={{ paddingTop: 40, }} >
                ...
                <View style={{ width: '100%', padding: 10, alignItems: 'center' }}>
                    <TouchableOpacity onPress={handleSignIn} style={{
                        ...
                        width: "100%",
                        height: 60,
                    }}><Text style={{ color: "#ffffff", textAlign: 'center', padding: 16, fontSize: 20, fontWeight: 600 }}>Validate OTP</Text></TouchableOpacity>
                </View>
                <View
                    style={{
                        paddingVertical: 30,
